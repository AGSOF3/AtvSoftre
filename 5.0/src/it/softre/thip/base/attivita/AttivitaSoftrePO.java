 ...
 * 
 *         </p>
 *         <b>71550	DSSOF3	12/06/2024</b>
 *         <p>
 *         Gestione Rubriche al posto dei Richiedenti.<br>
 *         </p>
 */

public abstract class AttivitaSoftrePO extends EntitaAzienda implements BusinessObject, Authorizable, Deletable, Conflictable {
	...
	//protected BigDecimal iRichiedenteSoftre;
	protected BigDecimal iRichiedenteCliente;
	...
	protected Proxy iIncaricato = new Proxy(Dipendente.class);

	//protected Proxy iRubricaSoftre = new Proxy(RubricaEstesa.class);
	protected Proxy iRubricaCliente = new Proxy(RubricaEstesa.class);
	protected Proxy iRichiedenteSoftre = new Proxy(Dipendente.class);

	//	protected Integer iIdAnagraficoSoftre =  10; //e' il codice anagrafico di Softre
	...
	/*public void setRichiedenteSoftre(BigDecimal richiedenteSoftre) {
		String key = iRubricaSoftre.getKey();
		iRubricaSoftre.setKey(KeyHelper.replaceTokenObjectKey(key , 2, richiedenteSoftre));
		setDirty();
	}

	public BigDecimal getRichiedenteSoftre() {
		String key = iRubricaSoftre.getKey();
		String objRSequenzaInd = KeyHelper.getTokenObjectKey(key,2);
		return KeyHelper.stringToBigDecimal(objRSequenzaInd);
	}*/

	public void setRichiedenteCliente(BigDecimal richiedenteCliente) {
		String key = iRubricaCliente.getKey();
		iRubricaCliente.setKey(KeyHelper.replaceTokenObjectKey(key , 2, richiedenteCliente));
		setDirty();
	}

	public BigDecimal getRichiedenteCliente() {
		String key = iRubricaCliente.getKey();
		String objRSequenzaInd = KeyHelper.getTokenObjectKey(key,2);
		return KeyHelper.stringToBigDecimal(objRSequenzaInd);
	}
	...
	public void setRichiedenteSoftre(String richiedenteSoftre) {
		String key = iRichiedenteSoftre.getKey();
		iRichiedenteSoftre.setKey(KeyHelper.replaceTokenObjectKey(key , 2, richiedenteSoftre));
		setDirty();
	}
	...
	public void setPriorita(char priorita) {
		this.iPriorita = priorita;
		setDirty();
	}

	public char getPriorita() {
		return iPriorita;
	}
	...
	public void setClientesoftre(ClienteSoftre clientesoftre) {
		...
		String key = iRubricaCliente.getKey();
		iRubricaCliente.setKey(KeyHelper.replaceTokenObjectKey(key , 1, clientesoftre.getIdAnagrafico()));
	}
	...
	public void setIdClienteSoftre(java.math.BigDecimal idClienteSoftre) {
		...
		iRubricaCliente.setKey(KeyHelper.replaceTokenObjectKey(key , 1, idClienteSoftre)); //aggiungere per valorizzare correttamente la Proxy
		setDirty();
	}
	...
	public void setIncaricato(Dipendente incaricato) {
		this.iIncaricato.setObject(incaricato);
		setDirty();
	}

	public Dipendente getIncaricato() {
		return (Dipendente) iIncaricato.getObject();
	}
	...
	public void setIdIncaricato(String idIncaricato) {
		...
		iIncaricato.setKey(KeyHelper.replaceTokenObjectKey(key , 2, idIncaricato));
		setDirty();
	}
	...
	public void setRubricaCliente(RubricaEstesa rubrica)
	{
		this.iRubricaCliente.setObject(rubrica);
		setDirty();
	}

	public RubricaEstesa getRubricaCliente()
	{
		return (RubricaEstesa)iRubricaCliente.getObject();
	}

	//Rubrica Softre

	/*public void setRubricaSoftre(RubricaEstesa rubrica)
	{
		this.iRubricaSoftre.setObject(rubrica);
		setDirty();
	}

	public RubricaEstesa getRubricaSoftre()
	{
		return (RubricaEstesa)iRubricaSoftre.getObject();
	}*/
	public void setRubricaSoftre(Dipendente rubrica)
	{
		this.iRichiedenteSoftre.setObject(rubrica);
		setDirty();
	}

	public Dipendente getRubricaSoftre()
	{
		return (Dipendente)iRichiedenteSoftre.getObject();
	}

	public void setRubricaSoftreKey(String key)
	{
		iRichiedenteSoftre.setKey(key);
		setDirty();
	}

	public String getRubricaSoftreKey()
	{
		return iRichiedenteSoftre.getKey();
	}

	//	public Integer getIdAnagraficoSoftre() {
	//		return iIdAnagraficoSoftre;
	//	}
	//
	//	public void setIdAnagraficoSoftre(Integer iIdAnagraficoSoftre) {
	//		String key = iRichiedenteSoftre.getKey();
	//		iRichiedenteSoftre.setKey(KeyHelper.replaceTokenObjectKey(key , 1, iIdAnagraficoSoftre));
	//		setDirty();
	//	}
	...
	protected void setIdAziendaInternal(String idAzienda) {
		...
		String key2 = iIncaricato.getKey();
		iIncaricato.setKey(KeyHelper.replaceTokenObjectKey(key2, 1, idAzienda));
		String key3 = iRichiedenteSoftre.getKey();
		iRichiedenteSoftre.setKey(KeyHelper.replaceTokenObjectKey(key3, 1, idAzienda));
	}
