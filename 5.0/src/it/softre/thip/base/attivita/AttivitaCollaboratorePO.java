...
public abstract class AttivitaCollaboratorePO extends EntitaAzienda implements BusinessObject, Authorizable, Deletable, Child, Conflictable {
	...
	protected Proxy iUtente = new Proxy(Dipendente.class);
	...
	public void setUtente(Dipendente utente) {
		this.iUtente.setObject(utente);
		setDirty();
		setOnDB(false);
	}
	...
	public Dipendente getUtente() {
		return (Dipendente) iUtente.getObject();
	}
	...
	public void setIdUtente(String idUtente) {
		...
		iUtente.setKey(KeyHelper.replaceTokenObjectKey(key , 2, idUtente));
		setDirty();
		setOnDB(false);
	}
	...
	protected void setIdAziendaInternal(String idAzienda) {
		...
		String key3 = iUtente.getKey();
		iUtente.setKey(KeyHelper.replaceTokenObjectKey(key3, 1, idAzienda));
	}
